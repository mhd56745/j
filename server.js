...
// ---- Trust proxy (required for Koyeb / reverse proxy deployments) ----
...
// ---- Live Stream Proxy (public - no auth required for players) ----
...
// ---- Fallback: Serve admin panel for all non-API, non-live routes ----
app.get('*', (req, res) => {
